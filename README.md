...
> **Material disponible:** Clase 01 (14 de septiembre) y Clase 02 (15 de septiembre de 2026), y Clase 03 (16 de septiembre) como borrador migrado, y Clase 04 (21 de septiembre) para revisión, con siete notebooks en total. Disponibilidad no significa aprobación académica ni ejecución completa de todas las prácticas. Consulta el estado de cada nota y la tabla de prácticas de esta guía.
...
- [Clase 04 — Aprendizaje supervisado y Random Forest geoespacial](01%20-%20Clases/2026-09-21%20-%20Clase%2004%20-%20Aprendizaje%20supervisado%20y%20Random%20Forest%20geoespacial.md): material para revisión; ejecución histórica independiente de 17/17 celdas, incluida la rama raster, mapa residual corregido mediante comprobación focal posterior y video parcial. Mapa abierto en Pro verificado; Notebook/Obsidian completos no verificados. Video parcial, excluido de esta preparación; borrador sin aprobación académica.

Los siete notebooks están enlazados en **Cómo ejecutar las prácticas**. El calendario no implica que ya existan notas para las nueve sesiones.
...
| Clase 04 · P01 | [Random Forest geoespacial](99%20-%20Recursos/notebooks/Clase%2004%20-%20Practica%2001%20-%20Random%20Forest%20geoespacial.ipynb) | 17/17 celdas de código completadas históricamente, incluida la rama raster en kernel independiente. Mapa AGBD y Scatter nativos inspeccionados; mapa residual corregido mediante comprobación focal posterior, sin reentrenar. [Ver resultados y límites](99%20-%20Recursos/salidas_clase_04/publicados/README.md). Mapa abierto en Pro verificado; Notebook/Obsidian completos no verificados. Video parcial, excluido de esta preparación; borrador sin aprobación académica. |
...
| C04 P01 | `DATA_DIR`: `99 - Recursos/datos/clase_04`; `Datos_Coiba.gdb`, solo lectura. `OUTPUT_DIR`: `99 - Recursos/salidas_clase_04/practica_01`, ejecución nueva con UUID. Véase [procedencia Coiba](99%20-%20Recursos/datos/clase_04/README.md). |
...
**Ajuste explícito de la clase activa:** Clase 04 se fecha **21/09/2026**, no 22/09. La tabla conserva la programación de las demás sesiones; este ajuste no reprograma Clase 05 ni resuelve su coincidencia de fecha. La nota de Clase 04 está disponible para revisión, con 17/17 celdas de código completadas históricamente, incluida la rama raster, video parcial y mapa residual corregido mediante comprobación focal posterior, sin verificación integral ni aprobación académica.
...
| 6. Aprendizaje Supervisado y AutoML | 6.1. Regresión y clasificación basada en bosques | 6 | **21 (Clase 04, ajuste explícito)**, 23 y 24 |
